...
user = {
  ...
  --  web_search_cmd = "xdg-open https://duckduckgo.com/?q=",
    ...
    lock_screen_password = "blue09950",
    ...
    openweathermap_key = "1f022da591551fc7555145ef3c42dd46",
    openweathermap_city_id = "3194510",
...
awful.rules.rules = {
    {
        ...
        properties = {
            ...
            maximized = false,
            floating = false,
            -- lacement = awful.placement.no_offscreen(c, {honor_workarea=true, margins=40})
        ...
        callback = function (c)
            if not awesome.startup then
                ...
                if awful.layout.get(mouse.screen) ~= awful.layout.suit.floating or #mouse.screen.clients == 1 then
                    ...
                    client_placement_f(c, {honor_padding = true, honor_workarea=true, margins = beautiful.useless_gap * 10})
                end
    ...
    -- File managers
    {
        ...
        properties = { floating = false, width = screen_width * 0.7, height = screen_height * 0.7}
    },
...
-- ===================================================================
awful.spawn.with_shell( "/home/c_danil0o/.config/awesome/autostart.sh")
--awful.spawn.with_shell("/home/c_danil0o/.config/awesome/locker.sh")
