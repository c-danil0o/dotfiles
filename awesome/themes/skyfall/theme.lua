...
theme.tasklist_shape_border_color_focus = x.color3
theme.tasklist_shape_border_color = "#6f6c78"
theme.tasklist_shape_border_color_minimized = "#3a3940"
...
theme.taglist_bg_empty = x.color8
theme.taglist_fg_empty = x.background
theme.taglist_bg_urgent = x.color8
