...
keys.desktopbuttons = gears.table.join(
    ...
    -- Right click - Show app drawer
     --2awful.button({ }, 3, function () mymainmenu:toggle() end),
...
keys.globalkeys = gears.table.join(
    awful.key({ superkey          }, "c",      hotkeys_popup.show_help,
    {description="show help", group="awesome"}),
    --awful.key({ superkey,           }, "comma",   awful.tag.viewprev,
    --{description = "view previous", group = "tag"}),
    --awful.key({ superkey,           }, "period",  awful.tag.viewnet,
    ...
    awful.key({ superkey, ctrlkey }, "i", function (c)
    ...
    awful.key({ superkey, altkey }, "l",   
        ...
        --change layout
    awful.key({ superkey,altkey         }, "space",
         function () 
            awful.layout.inc( 1)   
                     end,
               {description ="change layout", group = "layout"}    ),
   ...
   --     end,
    ...
    awful.key({ superkey }, "g",
        function ()
            awful.spawn("firefox https://www.google.com")
        end,
    ...
    awful.key( { altkey, shiftkey }, "m",
        ...
        {description = "(un)mute volume", group = "volume"}),
    awful.key( { altkey, shiftkey }, "k",
        function()
            helpers.volume_control(-5)
        end,
        {description = "lower volume", group = "volume"}),
    awful.key( { altkey, shiftkey }, "i",
        function()
            helpers.volume_control(5)
        end,
        {description = "raise volume", group = "volume"}),
    ...
    awful.key( {  }, "Print", function() helpers.screenshot("selection") end,
    ...
    -- Media keys
    awful.key({ altkey, shiftkey }, "l", function() awful.spawn.with_shell("mpc -q next") end,
        {description = "next song", group = "media"}),
    awful.key({ altkey, shiftkey }, "j", function() awful.spawn.with_shell("mpc -q prev") end,
        {description = "previous song", group = "media"}),
    awful.key({ altkey, shiftkey }, "space", function() awful.spawn.with_shell("mpc -q toggle") end,
        {description = "toggle pause/play", group = "media"}),
    awful.key({ altkey, shiftkey }, "l", function() awful.spawn.with_shell("mpvc next") end,
        {description = "mpv next song", group = "media"}),
    awful.key({ altkey, shiftkey }, "j", function() awful.spawn.with_shell("mpvc prev") end,
        {description = "mpv previous song", group = "media"}),
    awful.key({ altkey, shiftkey}, "space", function() awful.spawn.with_shell("mpvc toggle") end,
    ...
    -- Toggle sidebar
    awful.key({ altkey }, "y", function() sidebar.visible = not sidebar.visible end,
...
keys.clientkeys = gears.table.join(
    ...
    awful.key({ superkey, shiftkey, ctrlkey }, "i", function (c)
        c:relative_move(0, dpi(-20), 0, 0)
    end),
