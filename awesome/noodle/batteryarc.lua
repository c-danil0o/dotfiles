...
local WIDGET_DIR = HOME .. '/.config/awesome/awidgets/awesome-wm-widgets/batteryarc-widget'
...
local function worker(user_args)
    ...
    local main_color = args.main_color or x.color2
    ...
    local enable_battery_warning = false
