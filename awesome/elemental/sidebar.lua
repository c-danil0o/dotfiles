...
weather_widget_icon.forced_width = icon_size
 ...
 weather_widget_text.font = "Iosevka 12"
...
fancy_time_widget.markup = fancy_time_widget.text:sub(1,3) .. "<span foreground='" .. x.color12 .."'>" .. fancy_time_widget.text:sub(4,5) .. "</span>"
...
sidebar.height = awful.screen.focused().geometry.height - 450
sidebar.width = beautiful.sidebar_width or dpi(300)
sidebar.y = beautiful.sidebar_y or 400
local radius = dpi(12)
...
if user.sidebar_show_on_mouse_screen_edge then
    local sidebar_activator = wibox({y = 10, width = 1, visible = true, ontop = true, opacity = 0})
    sidebar_activator.height = dpi(100)
